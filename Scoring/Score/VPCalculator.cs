namespace Scoring.Score
{
    public class VPCalculator
    {
        ...
        private static readonly short[] WBF_BOARDS = { 8, 10, 12, 14, 16, 20, 24, 28,
            32, 36, 40, 48 };

        private static VPPoints[] WBF_POINTS = { new VPPoints(15, 15),
        ...
        // From WBF 2010
        private static readonly short[,] WBF_IMP = {
