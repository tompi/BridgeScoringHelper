public static class Calculator {
	...
	public static int GetNorthSouthPoints(Contract Contract, int boardNumber) {
        ...
        bool vulnerable = Board.GetVulnerability(boardNumber).IsVulnerable(
				direction);
		return GetNorthSouthPoints(Contract, vulnerable);
	}

	public static int GetNorthSouthPoints(Contract contract, bool vulnerable) {
	...
	public static int GetPoints(Contract contract, bool vulnerable) {
		if (contract.Level < 1) {
			return 0;
		}
	...
	public static int GetLevelBonus(Contract contract, bool vulnerable,
			int contractPoints, bool rubberScoring) {
	...
	public static int GetOverTrickPoints(Contract contract, bool vulnerable) {
	...
	public static int GetPenalty(Contract contract, bool vulnerable) {
		if (contract.ContractMade()) {
			return 0;
		}
	...
	private static readonly short[] DOUBLED_NOZONE = { -100, -300, -500, -800,
			-1100, -1400, -1700, -2000, -2300, -2600, -2900, -3200, -3500 };
	private static readonly short[] DOUBLED_ZONE = { -200, -500, -800, -1100,
			-1400, -1700, -2000, -2300, -2600, -2900, -3200, -3500, -3800 };
	private static readonly short[] REDOUBLED_NOZONE = { -200, -600, -1000, -1600,
			-2200, -2800, -3400, -4000, -4600, -5200, -5800, -6400, -7000 };
	private static readonly short[] REDOUBLED_ZONE = { -400, -1000, -1600, -2200,
